...
export const Work = () => {
  ...
  const works = [
    ...
    },
    {
      ...
      imgUrl: proj3Img1,
      content: "Flask site where user input will be checked against three different algorithms on whether it is a spam/scam or ham message. Different datasets were used in order to train a Naive-Bayes, a Logistic Regression and a Word Count algorithm, which are then imported to the back-end of the application and worked with.", 
    ...
    },
    {
      ...
      imgUrl: proj7Img1,
      content: "Android application possibly useful for animal shelters and volunteers. The purpose is to save a route/walk done by the user (with Google Maps API) and add information about stray animals seen during it. The app can be useful to monitor the life and/or problems of stray animals in the area.",
      keywords: "Keywords: Kotlin, Room",
      picture1: proj7Img2,
      picture2: proj7Img3,
      picture3: proj7Img4
